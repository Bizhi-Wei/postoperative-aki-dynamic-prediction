...
def _libreoffice_profile_uri(path: str) -> str:
    """Return a valid file URI for LibreOffice on Windows and POSIX."""
...
def convert_to_pdf(
    ...
    cmd_pdf = [
        "soffice",
        "-env:UserInstallation=" + _libreoffice_profile_uri(user_profile),
        "--invisible",
        "--headless",
        "--norestore",
        "--convert-to",
